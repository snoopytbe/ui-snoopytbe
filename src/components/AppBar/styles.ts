...
export const appBarStyles = {
    // Barre principale
    bar: "bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40 dark:bg-gray-800 dark:border-gray-700",
    ...
    logoText: "text-xl font-semibold text-gray-900 dark:text-gray-100",
