...
export const buttonStyles = {
    ...
    // Boutons spéciaux
    icon: "p-2 rounded-full hover:bg-gray-100 focus:ring-2 focus:ring-gray-500 dark:hover:bg-gray-700",
    ...
    formSecondary: "bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-500 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
} as const;
