...
export const sidePanelStyles = {
    ...
    // Panneau déplié
    panel: {
        base: "pointer-events-auto h-full flex flex-col backdrop-blur-lg bg-white/40 border-l border-white/50 shadow-2xl dark:bg-gray-900/60 dark:border-white/10",
        header: "shrink-0 backdrop-blur-md bg-gray-50 border-b border-white/50 p-4 text-center dark:bg-gray-800 dark:border-white/10",
        title: "text-xl font-bold text-gray-900 dark:text-gray-100",
        content: "flex-1 overflow-y-auto p-4 space-y-4",
        footer: "shrink-0 backdrop-blur-md bg-white/60 border-t border-white/50 p-4 flex items-center justify-between gap-4 dark:bg-gray-800/60 dark:border-white/10",
    },
} as const;
