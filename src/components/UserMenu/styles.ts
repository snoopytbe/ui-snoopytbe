...
export const userMenuStyles = {
  ...
  dropdownDivider: "my-2 border-gray-200 dark:border-gray-700",
  dropdownItem: "flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded cursor-pointer focus:outline-none focus:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:bg-gray-700",
